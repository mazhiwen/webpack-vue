...
export default {
 ...
 geo: {
                    ...
                    "normal": {
                        "areaColor": {
                            ...
                            "colorStops": [
                                {
                                    "offset": 0,
                                    "color": "rgba(84,225,186,0.6)"
                                },
                                {
                                    "offset": 1,
                                    "color": "rgba(136,237,186,0.6)"
                                }
                            ],
                            "globalCoord": false
                        }
          ...
          itemStyle: {
            normal: {
              borderColor: 'rgba(86,84,84, 1)',
              borderWidth: 0.6,
              areaColor: 'rgba(12,35,80, 1)',
            },
          },
        ...
        series: [
          {
            ...
            data: [
              [116.6609269,40.21669317,'乌鲁木齐']
            ],
                symbolKeepAspect: true,
                symbol: "path://M24.99721908569336,0C29.42127227783203,0,33,3.495593309402466,33,7.799322128295898C33,11.845423698425293,29.23218536376953,16.938304901123047,26.72679901123047,21.0440673828125C25.9454288482666,22.31864356994629,24.0545711517334,22.31864356994629,23.275981903076172,21.0440673828125C20.762252807617188,16.938304901123047,17,11.842711448669434,17,7.799322128295898C17,3.495593309402466,20.57872772216797,0,24.99721908569336,0ZM29,7.998769283294678C29,5.526848316192627,26.756473541259766,3.580453634262085,24.20159339904785,4.078174591064453C22.641977310180664,4.381256103515625,21.388166427612305,5.6297287940979,21.079580307006836,7.189625263214111C20.576387405395508,9.750524520874023,22.52799415588379,12,24.99947166442871,12C27.215185165405273,12,29.00554656982422,10.20097541809082,29,7.998769283294678Z",

            symbolSize: 25,
            label: {
              color: '#fff',
              fontSize: 15,
              backgroundColor: 'rgba(252,77,52,0.6)',
              borderRadius: 5,
              borderColor: '#FC4D34',
              borderWidth: 1,
              padding: [6, 9],
